...
func TestCreateBaseHtmlDataMissingPlaceHolder1(t *testing.T) {
	path := test.CreateTestFileReturnPath("foo.html", test.ConfigDataContent+"XXX-BODY-XXX XXX-INDEX-XXX XXX-BOTTOMBAR-XXX")
...
func TestCreateBaseHtmlDataMissingPlaceHolder2(t *testing.T) {
	path := test.CreateTestFileReturnPath("foo.html", test.ConfigDataContent+"XXX-TOPBAR-XXX XXX-INDEX-XXX XXX-BOTTOMBAR-XXX")
...
func TestCreateBaseHtmlDataMissingPlaceHolder3(t *testing.T) {
	path := test.CreateTestFileReturnPath("foo.html", test.ConfigDataContent+"XXX-TOPBAR-XXX XXX-BODY-XXX XXX-BOTTOMBAR-XXX")
